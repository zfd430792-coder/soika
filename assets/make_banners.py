...
BANNERS: list[tuple[str, str, str, int]] = [
    ...
    ("server_banner", "СЕРВЕР", "нагрузка, память, диски и сеть", 48),
    ("access_banner", "ДОСТУП", "где допущенным можно работать", 48),
    ("limiter_banner", "ЛИМИТЕР", "защита от FLOOD_WAIT", 48),
]
